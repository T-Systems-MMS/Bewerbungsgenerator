...
namespace TSystems.MMS.Bewerbungsgenerator.Controllers
{
    public class FormsController : Controller
    {
        private readonly TSystemsMMSBewerbungsgeneratorContext _context;

        public FormsController(TSystemsMMSBewerbungsgeneratorContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FristName,LastName,Telephone,Organisation,Motivation,Study,TheRight")] Form form)
        {
